...
import edu.lternet.pasta.dml.parser.Constraint;
 ...
 * 
 * JUnit tests for the GenericDataPacakgeParser class.
 *
 */

public class GenericDataPackageParserTest extends TestCase
{
  /*
   * Class fields
   */
  
  private static final String EMLSAMPLELOCATION = "test/data/eml-sample.xml";
   ...
   * Constructor
   */
  public GenericDataPackageParserTest (String name)
  {
    super(name);
  }
   ...
   */
   public static Test suite()
   {
     ...
     suite.addTest(new GenericDataPackageParserTest("testParse"));
     return suite;
   }
  ...
  /**
   * Tests GenericDataPackageParser parsing of an EML document.
   */
  public void testParse() throws Exception
  {
	  ...
	  DataPackageParserInterface parser = 
		  new GenericDataPackageParser("//eml/@packageId");
