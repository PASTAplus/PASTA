...
public class DataPackageManagerResource extends PastaWebService {
	 ...
	 */
	private boolean isServiceMethodAuthorized(
            String serviceMethodName,
    ...
    @OPTIONS @Path("/thumbnail/eml/{scope}/{identifier}/{revision}/{entityId}")
    @Consumes({"image/jpeg", "image/png"})
    @Produces("text/plain")
    public Response thumbnailPreflight (
            @Context HttpHeaders headers,
            @PathParam("scope") String scope,
            @PathParam("identifier") Integer identifier,
            @PathParam("revision") Integer revision,
    ...
    @OPTIONS @Path("/thumbnail/eml/{scope}/{identifier}/{revision}")
    @Consumes({"image/jpeg", "image/png"})
    @Produces("text/plain")
    public Response thumbnailPreflight (
            @Context HttpHeaders headers,
    ...
    public Response deleteResourceThumbnail (
		...
		(@Context HttpHeaders headers, @PathParam("subscriptionId") String
		subscriptionId){
