...
ECHO List Recent Inserts
curl -i -G "%SERVICE_HOST%/package/uploads/eml?type=insert&limit=5"

ECHO List Recent Updates
curl -i -G "%SERVICE_HOST%/package/uploads/eml?type=update&limit=5"
