...
public class TestScaledNumberFormat {

	private ScaledNumberFormat scaledNumberFormat = new ScaledNumberFormat();
	private long number;
	...
	public TestScaledNumberFormat(long number, String expect) {
		this.number = number;
		this.expect = expect;
	}
	...
	public void testFormat() {
		String actual = scaledNumberFormat.format(number);
