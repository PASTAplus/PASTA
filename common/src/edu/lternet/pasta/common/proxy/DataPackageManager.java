...
/**
 * Used to interact with PASTA's Data Package Manager via web service calls.
 *
 */
public final class DataPackageManager {
    ...
    /**
     * The key used in {@code PastaUrls.properties} to define the Data Package
     * Manager's root URL.
     */
    public static final String URL_KEY = "datapackage.manager.url";

    /**
     * Returns the root URL used to interact with PASTA's Data Package Manager,
     * such as {@code https://package.lternet.edu/package/}.
     */
    ...
    private static String makeUrl(EmlPackageId packageId) {
        ...
        return getRootUrl() + "metadata/eml/" + format.format(packageId);
    }

    /**
     * Returns the EML document with the provided packageId by requesting it
     * from PASTA's Data Package Manager.
     *
     * @param packageId
     ...
     *             if the request to PASTA's Data Package Manager fails.
     */
    public static String getMetadata(EmlPackageId packageId, AuthToken token) {
        ...
        try {
            ...
            String s = "An exception was thrown while sending a request to " +
                       "PASTA's Data Package Manager for the EML document " +
        ...
        String s = "The EML document with packageId '" +
                   ...
                   "' was requested from PASTA's Data Package Manager, " +
    ...
    /**
     * Inserts an EML document in PASTA's Data Package Manager.
     *
     * @param eml
    ...
    public static void insertMetadata(String eml, AuthToken token) {
        ...
        try {
            ...
            String s = "An exception was thrown while sending a request to " +
                       "PASTA's Data Package Manager to create an EML document. " +
                       "The stack trace is shown below.";
        ...
        String s = "A request was made to create the provided EML document " +
                   "in PASTA's Data Package Manager, but the request failed. " +
        		           "The response from the Data Package Manager is shown below.";
     ...
     *            the authorization token used to make the request.
     *
     * @return {@code true} or {@code false}, if the Data Package Manager
     *         clearly indicates existence or non-existence, respectively, of
     *         the specified EML document.
     *
     * @throws JerseyProxyException
