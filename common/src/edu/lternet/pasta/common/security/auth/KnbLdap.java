 ...
 * {@code ldap.ecoinformatics.org} on port 389. If successful, a request is
 * made to StartTLS.
 * </p>
 * <p>
 * Authentication is first attempted directly with KNB's LDAP, but if that
 * fails, its LDAP referral URLs will be queried and examined. If one of those URLs
 * references the organization (o=<em>org</em>) that is contained in the
...
public final class KnbLdap extends Ldap {
    ...
    private static final String KNB_SERVER = "ldap.ecoinformatics.org";
    ...
    public boolean authenticate(String user, String password) {
        ...
        return authenticate(user, password, KNB_SERVER, checkReferrals);
    }

    /**
     * Returns an LDAP connection to the specified host with all of the
    ...
    private LDAPConnection makeConnection(String host) {
        ...
        try {
            ...
            SSLUtil sslUtil =
                new SSLUtil(new TrustStoreTrustManager(keystoreFile));
     ...
     * set to {@code true}, which involves recursively calling this method
     * again.
     */
