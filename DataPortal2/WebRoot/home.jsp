...
<%
    ...
    if (pastaHost.startsWith("pasta-d") || 
       ...
       tier = "development";
       sunset = "The LTER Network Data Portal in the development environment (this website) will be officially sunsetted 1 September 2020. Please transition to the EDI Data Portal (https://portal-d.edirepository.org) in the same environment for uninterrupted access to the EDI data repository. The EDI Data Portal provides improved services and new features compared to the LTER Data Portal. Send questions or comments to support@enivronmentaldatainitiative.org.";
    }
    else if (pastaHost.startsWith("pasta-s")) {
       tier = "staging";
       sunset = "The LTER Network Data Portal in the staging environment (this website) will be officially sunsetted 1 September 2020. Please transition to the EDI Data Portal (https://portal-s.edirepository.org) in the same environment for uninterrupted access to the EDI data repository. The EDI Data Portal provides improved services and new features compared to the LTER Data Portal. Send questions or comments to support@enivronmentaldatainitiative.org.";

    }
    else {
        sunset = "The LTER Network Data Portal (this website) will be officially sunsetted 1 September 2020. Please transition to the EDI Data Portal (https://portal.edirepository.org) for uninterrupted access to the EDI data repository. The EDI Data Portal provides improved services and new features compared to the LTER Data Portal. Send questions or comments to support@enivronmentaldatainitiative.org.";
  }
