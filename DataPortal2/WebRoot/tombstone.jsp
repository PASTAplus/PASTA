...
<%
  final String pageTitle = "Tombstone Landing Page";
  final String titleText = DataPortalServlet.getTitleText(pageTitle);
  
  String tombstoneMessage = (String) request.getAttribute("tombstoneMessage");
  if (tombstoneMessage == null) tombstoneMessage = "";
