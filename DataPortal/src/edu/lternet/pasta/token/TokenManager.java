 ...
 * @since Mar 9, 2012
 * 
 * The TokenManager manages the NIS Data Portal "tokenstore" for storing user
...
public class TokenManager {
    ...
    private static final Logger logger = Logger.getLogger(edu.lternet.pasta.token.TokenManager.class);
    ...
    public static void main(String[] args) {
        ...
        String token = "sz46tDcFxqLby2TtlBARREdqGFSSRFbjSHPvMw0hgXLsG2uGlDWrOzjf/zM7Yd7g4n8pK5qKzohvP9UdYqf/xyx/RBAUU1QYwmUXTA5NnUZ5qHjYCtx3Y+DgwyNsQPoz6dQqR92BWWsWb39BilwfaRoyg8vRbmJ3CFRslvB5WfUqEI2OIhD2h3VyYXq8V7f8X4IZDSHWMWNXYMuxC3eQ+A==";
        String uid = "ucarroll";
    ...
    private Connection getConnection() throws ClassNotFoundException {
       ...
       */
      public void setToken(String uid, String token) throws SQLException, ClassNotFoundException {
       ...
       * @throws ClassNotFoundException 
       */
      public String getToken(String uid) throws SQLException, ClassNotFoundException {
       ...
       * @throws ClassNotFoundException 
       */
      public void deleteToken(String uid) throws SQLException, ClassNotFoundException {
