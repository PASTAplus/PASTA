	...
	<div class="wrapper">
		...
		<div class="content">
			...
			<fieldset>
				...
				<p><em>Please note: Deletion of a data package is permanent and should be given careful consideration. Once deleted, no additional data packages can be uploaded with the specified combination of scope and identifier.</em></p>
